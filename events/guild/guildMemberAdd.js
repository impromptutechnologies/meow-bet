...
module.exports = async (client, discord, member) => {
    ...
    const newEmbed = new Discord.MessageEmbed()
      ...
      Trust us, its worth it.\nWe've given you 10 tokens to play around with and you can access the list of commands on our website ([meowbot.gg/bets](http://meow-web.herokuapp.com)) along with the latest events you can bet on.`)
