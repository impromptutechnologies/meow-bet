...
module.exports = async (client, discord, guild) => {
  ...
  guild.channels.cache.forEach((channel) => {
    ...
    const newEmbed = new Discord.MessageEmbed()
      ...
      .setDescription(`Our bot allows you to bet on major sports matches, stock/crypto prices, and a host of cool casino games such as blackjack, dice, slots and more! We give you 1000 free tokens or you can purchase a lootbox containing tokens, premium commands and the monthly giveaway/lottery. 
